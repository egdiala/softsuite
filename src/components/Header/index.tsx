                ...
                <div>
                    <div className="flex items-center gap-10">
                        ...
                        <div className="flex items-start gap-5">
                            <img src="https://avatars.githubusercontent.com/u/46764458?v=4" className="w-12 h-12 rounded-full" alt="user" />
                            <div className="grid pr-8">
                                <h1 className="text-lg font-semibold text-primary">Egwuchukwu Diala</h1>
                                <span className="text-base text-primary/40">Payroll Manager</span>
                            </div>
                        </div>
                    </div>
                </div>
